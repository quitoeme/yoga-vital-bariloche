...
export default function FloatingWhatsApp() {
  return (
    ...
    >
      ...
      {/* Glifo oficial de WhatsApp (Simple Icons). El anterior era un trazado
          dibujado a mano con dos subtrazados en un solo <path>: con
          fill-rule nonzero el auricular no se recortaba del globo y se
          rellenaba todo, así que se veía un borrón blanco. */}
